...
const Inventory = ({ inventory }) => {
    const { _id, name, image, description, price, quantity, supplierName, sold } = inventory;
            ...
            {Array.from({ length: 1 }).map((_, idx) => (
                <Col>
                    <Card className='p-3 border-dark rounded-3'>
                        <Card.Img variant="top" src={image} className="border border-success rounded-3" style={{ width: "400", height: "400px" }} />
                        <Card.Body>
